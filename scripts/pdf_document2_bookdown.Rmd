...
This is a simple example of a Bookdown document that can be rendered to a Pdf document format. You can include text, code chunks, and other elements as needed.
...
```{r example-figure2, echo=FALSE, fig.cap="Grumpy cat", fig.align='center'}

knitr::include_graphics("../slides/pics/Grumpy_Cat.jpg", dpi = 300)
